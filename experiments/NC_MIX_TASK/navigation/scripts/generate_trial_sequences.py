...
用法（项目根目录）：
  python navigation6/scripts/generate_trial_sequences.py
  python navigation6/scripts/generate_trial_sequences.py --trials 27 --seed 20260319
  python navigation6/scripts/generate_trial_sequences.py --maps map_1773511099.json map_1773512012.json
"""
...
def main() -> int:
    ...
    from app.paths import maps_dir, trial_sequences_dir
