...
用法（项目根目录）：
  python navigation6/scripts/run_agent_experiment.py --agent pure --map map_1774095558.json
  python navigation6/scripts/run_agent_experiment.py --agent noisy --epsilon 0.1 --seed 42
"""
...
from app.experiment.main import EXPERIMENT_MAPS
from app.paths import get_nav6_root
