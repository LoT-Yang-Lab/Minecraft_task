...
def get_nav6_root() -> str:
    # navigation/app/paths.py -> NC_MIX_TASK/navigation
    return os.path.normpath(os.path.join(os.path.abspath(__file__), "..", ".."))


def get_project_root() -> str:
    # NC_MIX_TASK/navigation -> NC_MIX_TASK
    return os.path.normpath(os.path.join(get_nav6_root(), ".."))
...
def data_dir() -> str:
    return os.path.join(get_project_root(), "data", "navigation")


def outputs_dir() -> str:
    return os.path.join(get_project_root(), "outputs", "navigation")
