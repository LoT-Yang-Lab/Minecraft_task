...
# 直接运行本脚本时，把 Navigation6 项目根加入 sys.path（内含 vendored shared/）。
_this_file = Path(__file__).resolve()
_nav6_root = _this_file.parents[2]  # app/editor/ -> navigation6
_nav6_root_str = str(_nav6_root)
if _nav6_root_str not in sys.path:
    sys.path.insert(0, _nav6_root_str)

DEBUG_LOG_PATH = os.path.join(_nav6_root_str, "debug-c9e6b4.log")
...
from app.editor.map_generator_nav6 import Navigation6MapGenerator
from app.editor.editor_data_nav6 import (
    EditorMapDataNav6,
    direction_from_room_centers,
    direction_from_points,
)
from app.editor.editor_constants_nav6 import (
...
from app.editor.editor_commands_nav6 import CommandHistory, CommandFactory
