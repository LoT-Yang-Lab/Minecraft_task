...
3. Keep crafting trials as placeholders in metadata, but skip them.
   (Symmetric: ``experiments/crafting/run_proposal5_experiment.py`` runs only crafting trials.)
...
_NAV6_ROOT = _THIS_FILE.parents[1]  # tests/ -> navigation6
_NAV6_ROOT_STR = str(_NAV6_ROOT)
if _NAV6_ROOT_STR not in sys.path:
    sys.path.insert(0, _NAV6_ROOT_STR)

from main2 import main as nav_main2
from app.paths import trajectory_raw_dir
from tests.trial_schedule import build_session_schedule, save_schedule
