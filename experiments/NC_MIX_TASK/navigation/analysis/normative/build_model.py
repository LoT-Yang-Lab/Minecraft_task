...
_nav6_root = os.path.normpath(os.path.join(_this_dir, "..", ".."))
if _nav6_root not in sys.path:
    sys.path.insert(0, _nav6_root)
# 可选：pgm-toolkit（项目内 vendor 或上级仓库「参考代码」）
_ref_candidates = [
    os.path.join(_nav6_root, "vendor", "pgm-toolkit-main", "src"),
    os.path.join(_nav6_root, "..", "..", "参考代码", "策略提取参考项目", "pgm-toolkit-main", "src"),
]
for _ref_src in _ref_candidates:
