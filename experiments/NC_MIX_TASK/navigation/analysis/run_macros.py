...
从项目根运行: python -m analysis.run_macros --maps-dir ... --trajectory-dir ...
"""
import argparse
import json
import os
...
def main():
    ...
    # 默认输出到 navigation6/outputs/analysis/macros
    output_dir = args.output_dir or os.path.join(_nav6_root, "outputs", "analysis", "macros")
    ...
    trajectory_dir = args.trajectory_dir or os.path.join(_nav6_root, "data", "raw", "trajectory")
    ...
    practice_dir = args.practice_dir or os.path.join(_nav6_root, "data", "raw", "practice")
