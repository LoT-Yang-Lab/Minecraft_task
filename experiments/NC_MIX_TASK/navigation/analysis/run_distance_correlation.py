...
从项目根运行: python -m analysis.run_distance_correlation --maps-dir ... --macro-usage ... --macro-catalog ...
"""
import argparse
import json
import os
...
def main():
    ...
    if args.maps_dir:
        ...
        maps_dir = _maps_dir()
    # 默认输出到 navigation6/outputs/analysis/distance
    output_dir = args.output_dir or os.path.join(_nav6_root, "outputs", "analysis", "distance")
