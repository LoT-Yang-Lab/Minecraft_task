...
运行示例（项目根目录）：
python -m analysis.visualize_macro_transitions ^
  --macro-catalog navigation6/outputs/analysis/macros/all_macros.json ^
  --macro-usage navigation6/outputs/analysis/macros/all_macro_usage.json ^
  --participant-id P01 ^
  --map-id map_1773511099 ^
  --out-dir navigation6/outputs/analysis/macros/viz_p01_map1
"""
